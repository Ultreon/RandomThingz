...
public class MoobloomModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(18, 4).mirror().addBox(-6f, -10f, -7f, 12f, 18f, 10f, new CubeDeformation(0f)).mirror(false)
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-4f, -4f, -6f, 8f, 8f, 6f, new CubeDeformation(0f)).mirror(false)
		...
		PartDefinition head_sub_0 = head.addOrReplaceChild("head_sub_0", CubeListBuilder.create().texOffs(0, 32).mirror().addBox(-1.5F, -32f, -12.5F, 3f, 8f, 3f, new CubeDeformation(0f)).mirror(false), PartPose.offset(0f, 20f, 8f));

		PartDefinition head_sub_1 = head.addOrReplaceChild("head_sub_1", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(4f, -42f, -21f, 2f, 2f, 1f, new CubeDeformation(0f)).mirror(false)
		...
		PartDefinition leg1 = partdefinition.addOrReplaceChild("leg1", CubeListBuilder.create().texOffs(0, 16).mirror().addBox(-2f, 0f, -2f, 4f, 12f, 4f, new CubeDeformation(0f)).mirror(false), PartPose.offset(4f, 12f, 7f));

		PartDefinition leg2 = partdefinition.addOrReplaceChild("leg2", CubeListBuilder.create().texOffs(0, 16).mirror().addBox(-2f, 0f, -2f, 4f, 12f, 4f, new CubeDeformation(0f)).mirror(false), PartPose.offset(-4f, 12f, 7f));

		PartDefinition leg3 = partdefinition.addOrReplaceChild("leg3", CubeListBuilder.create().texOffs(0, 16).mirror().addBox(-2f, 0f, -1f, 4f, 12f, 4f, new CubeDeformation(0f)).mirror(false), PartPose.offset(4f, 12f, -6f));

		PartDefinition leg4 = partdefinition.addOrReplaceChild("leg4", CubeListBuilder.create().texOffs(0, 16).mirror().addBox(-2f, 0f, -1f, 4f, 12f, 4f, new CubeDeformation(0f)).mirror(false), PartPose.offset(-4f, 12f, -6f));
