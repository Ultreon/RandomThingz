...
public class Hog extends Pig {
    ...
    public Hog(EntityType<? extends Hog> type, Level dimensionIn) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(7, new LookAtPlayerGoal(this, Player.class, 7f));
        this.goalSelector.addGoal(7, new LookAtPlayerGoal(this, Creeper.class, 10f));
    ...
    protected void playStepSound(@NotNull BlockPos pos, BlockState blockIn) {
        if (!blockIn.getMaterial().isLiquid()) {
            this.playSound(SoundEvents.PIG_STEP, .15f, 1f);
        }
    }
    ...
    public Hog getBreedOffspring(ServerLevel dimensionIn, AgeableMob ageable) {  // createChild
