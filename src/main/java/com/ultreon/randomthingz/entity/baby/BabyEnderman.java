...
public class BabyEnderman extends EnderMan implements BabyMob {
    ...
    private static final EntityDataAccessor<Boolean> IS_CHILD = SynchedEntityData.defineId(BabyEnderman.class, EntityDataSerializers.BOOLEAN);

    public BabyEnderman(EntityType<BabyEnderman> type, Level dimension) {
