 ...
 */
public class BabyEndermanEntity extends EnderMan implements IBabyEntity {

    private static final EntityDataAccessor<Boolean> IS_CHILD = SynchedEntityData.defineId(BabyEndermanEntity.class, EntityDataSerializers.BOOLEAN);

    public BabyEndermanEntity(EntityType<BabyEndermanEntity> type, Level dimension) {
