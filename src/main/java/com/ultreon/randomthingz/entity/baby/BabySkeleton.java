 ...
 * @author Ultreon Team.
 */
public class BabySkeleton extends Skeleton implements BabyMob {

    private static final EntityDataAccessor<Boolean> IS_CHILD = SynchedEntityData.defineId(BabySkeleton.class, EntityDataSerializers.BOOLEAN);

    public BabySkeleton(EntityType<BabySkeleton> type, Level dimension) {
