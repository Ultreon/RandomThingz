...
public class BabyCreeper extends Creeper implements BabyMob {
    ...
    private static final EntityDataAccessor<Boolean> IS_CHILD = SynchedEntityData.defineId(BabyCreeper.class, EntityDataSerializers.BOOLEAN);

    public BabyCreeper(EntityType<BabyCreeper> type, Level dimension) {
