 ...
 * @author Qboi123
 */
public class Cluckshroom extends Chicken {
    private static final Ingredient TEMPTATION_ITEMS = Ingredient.of(Tags.Items.MUSHROOMS);

    public Cluckshroom(EntityType<? extends Chicken> type, Level dimensionIn) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(6, new LookAtPlayerGoal(this, Cluckshroom.class, 7f));
    ...
    public Cluckshroom getBreedOffspring(ServerLevel dimensionIn, AgeableMob ageable) {  // createChild
