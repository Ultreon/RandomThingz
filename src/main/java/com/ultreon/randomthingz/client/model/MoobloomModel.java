package com.ultreon.randomthingz.client.model;// Made with Blockbench 4.1.5
...
public class MoobloomModel<T extends Moobloom> extends QuadrupedModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "moobloom_model"), "main");
