...
public abstract class HudItem extends Item {
        ...
        if (event.getType() == RenderGameOverlayEvent.ElementType.LAYER) {
            ...
            if (player != null) {
                ...
                if (item instanceof HudItem hudItem) {
                    GraphicsUtil gu = new GraphicsUtil(mc.getItemRenderer(), pose, mc.font);
                    hudItem.renderHud(pose, gu, mc, stack, player);
                }
            }
        }
    }
    ...
    @OnlyIn(Dist.CLIENT)
    public abstract void renderHud(PoseStack pose, GraphicsUtil gu, Minecraft mc, ItemStack stack, LocalPlayer player);
