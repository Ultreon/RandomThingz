...
public class RefineryContainer extends AbstractMachineBaseContainer<RefineryTileEntity> {
    public RefineryContainer(int id, Inventory playerInventory) {
        this(id, playerInventory, new RefineryTileEntity(), new SimpleContainerData(RefineryTileEntity.FIELDS_COUNT));
    }

    public RefineryContainer(int id, Inventory playerInventory, RefineryTileEntity tileEntity, ContainerData fieldsIn) {
