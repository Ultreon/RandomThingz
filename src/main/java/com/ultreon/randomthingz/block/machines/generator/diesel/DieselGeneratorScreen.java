...
public class DieselGeneratorScreen extends MachineContainerScreen<DieselGeneratorContainer> {
    ...
    protected void renderTooltip(PoseStack matrixStack, int x, int y) {
        if (isHovering(135, 17, 13, 51, x, y)) {
            Component text = TextUtils.fluidWithMax(menu.getFluidInTank(), 4000);
    ...
    protected void renderBg(PoseStack matrixStack, float partialTicks, int x, int y) {
        ...
        // Fluid tank
        RenderUtils.renderGuiTank(menu.getFluidInTank(), 4000, xPos + 136, yPos + 18, 0, 12, 50);
    }
}
