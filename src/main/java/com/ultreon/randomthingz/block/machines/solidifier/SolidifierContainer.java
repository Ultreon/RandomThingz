...
public class SolidifierContainer extends AbstractMachineBaseContainer<SolidifierTileEntity> {
    public SolidifierContainer(int id, Inventory playerInventory) {
        this(id, playerInventory, new SolidifierTileEntity(), new SimpleContainerData(SolidifierTileEntity.FIELDS_COUNT));
    }

    public SolidifierContainer(int id, Inventory playerInventory, SolidifierTileEntity tileEntity, ContainerData fieldsIn) {
