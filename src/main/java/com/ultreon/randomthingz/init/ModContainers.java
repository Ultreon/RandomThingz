...
public class ModContainers extends ObjectInit<MenuType<?>> {
    ...
    // Crates, chests.
    public static final RegistryObject<MenuType<CrateContainer>> WOODEN_CRATE = CONTAINER_TYPES.register("wooden_crate", () -> IForgeMenuType.create(CrateContainer::new));
