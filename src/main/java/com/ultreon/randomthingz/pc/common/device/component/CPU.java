...
public class CPU {
    ...
    public enum Opcode implements Runnable {
        ...
        public String getMode01(byte opcode) {
            switch (opcode) {
                case 0x00:
                    return "IndirectIndexedZeroPagedX";
                case 0x04:
                    return "ZeroPaged";
                case 0x08:
                    return "Immediate";
        ...
        public String getMode02(byte opcode) {
            switch (opcode) {
                ...
                case 0x1C:
                    return "IndexedAbsoluteX";
                default:
                    return "Type 2 Undefined";
            }
        }

        public String getMode03(byte opcode) {
            return "";
        }
        ...
        public void decode() {
            switch (this.code & 0x03) {
                case 0x00:
                    this.addressMode = getMode00((byte) (this.code & 0x1C));
                    break;
                case 0x01:
                    this.addressMode = getMode01((byte) (this.code & 0x1C));
                    break;
                case 0x02:
                    this.addressMode = getMode02((byte) (this.code & 0x1C));
                    break;
                case 0x03:
                    this.addressMode = getMode03((byte) (this.code & 0x1C));
                    break;
                default:
                    break;
            }
