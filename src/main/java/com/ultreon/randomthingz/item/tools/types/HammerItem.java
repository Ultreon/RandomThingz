...
public class HammerItem extends PickaxeItem implements IHasToolType {
    ...
    static {
        ...
        registerSmashMapping(Blocks.CRACKED_STONE_BRICKS, Blocks.COBBLESTONE.getDefaultState());
        registerSmashMapping(Blocks.CHISELED_STONE_BRICKS, Blocks.COBBLESTONE.getDefaultState());
        registerSmashMapping(Blocks.MOSSY_STONE_BRICKS, Blocks.MOSSY_COBBLESTONE.getDefaultState());
        ...
        registerSmashMapping(Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS, Blocks.BLACKSTONE.getDefaultState());
        registerSmashMapping(Blocks.POLISHED_BLACKSTONE, Blocks.BLACKSTONE.getDefaultState());
        registerSmashMapping(Blocks.POLISHED_BLACKSTONE_BRICK_SLAB, Blocks.BLACKSTONE_SLAB.getDefaultState());
    ...
    @SubscribeEvent
    public static void onClick(PlayerInteractEvent.LeftClickBlock event) {
...
//    }
//
//    private static void leftClickBlockServer(BlockPos blockpos, ServerPlayerEntity player, Direction dir) {
//        player.interactionManager.func_225416_a(blockpos, CPlayerDiggingPacket.Action.START_DESTROY_BLOCK, dir, player.server.getBuildLimit());
//    }
