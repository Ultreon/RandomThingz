...
import static com.ultreon.randomthingz.commons.FeatureStatus.*;
...
public enum Toolset {
    ...
    REDSTONE(builder("redstone")
            ...
            .armor(() -> com.ultreon.randomthingz.util.builder.ArmorMaterial.builder()
                    ...
                    .build())
            .tools(() ->  com.ultreon.randomthingz.util.builder.ItemTier.builder()
    ...
    OBSIDIAN(builder("obsidian")
            ...
            .armor(() -> com.ultreon.randomthingz.util.builder.ArmorMaterial.builder()
                    ...
                    .build())
            .tools(() -> TraitPack.create().all(ModTraits.SHARP.get(), ModTraits.BLAZE.get()).build(), () -> com.ultreon.randomthingz.util.builder.ItemTier.builder()
    ...
    SILVER(builder("silver")
            ...
            .armor(() -> TraitPack.create().all(ModTraits.HOLY.get()).build(), () -> com.ultreon.randomthingz.util.builder.ArmorMaterial.builder()
                    ...
                    .build())
            .tools(() -> TraitPack.create().all(ModTraits.HOLY.get()).build(), () -> com.ultreon.randomthingz.util.builder.ItemTier.builder()
    ...
    LEAD(builder("lead")
            ...
            .armor(() -> TraitPack.create().all(ModTraits.POISON.get(), ModTraits.SHARP.get()).build(), () -> com.ultreon.randomthingz.util.builder.ArmorMaterial.builder()
                    ...
                    .build())
            .tools(() -> TraitPack.create().all(ModTraits.POISON.get(), ModTraits.SHARP.get()).build(), () -> com.ultreon.randomthingz.util.builder.ItemTier.builder()
    ...
    TUNGSTEN(builder("tungsten", DEPRECATED)
    ...
    ZINC(builder("zinc")
            ...
            .armor(() -> TraitPack.create().all(ModTraits.POISON.get()).build(), () -> com.ultreon.randomthingz.util.builder.ArmorMaterial.builder()
                    ...
                    .build())
            .tools(() -> TraitPack.create().all(ModTraits.POISON.get()).build(), () -> com.ultreon.randomthingz.util.builder.ItemTier.builder()
    ...
    BISMUTH(builder("bismuth", DEPRECATED)
    ...
    ALUMINUM(builder("aluminum")
            ...
            .armor(() -> com.ultreon.randomthingz.util.builder.ArmorMaterial.builder()
                    ...
                    .build())
            .tools(() -> TraitPack.create().all(ModTraits.SHARP.get()).build(), () -> com.ultreon.randomthingz.util.builder.ItemTier.builder()
    ...
    URANIUM(builder("uranium")
            ...
            .armor(() -> TraitPack.create().all(ModTraits.RADIOACTIVE.get()).build(), () -> com.ultreon.randomthingz.util.builder.ArmorMaterial.builder()
                    ...
                    .build())
            .tools(() -> TraitPack.create().all(ModTraits.RADIOACTIVE.get()).build(), () -> com.ultreon.randomthingz.util.builder.ItemTier.builder()
    ...
    BRASS(builder("brass", DEPRECATED)
    ...
    INVAR(builder("invar", DEPRECATED)
    ...
    STEEL(builder("steel")
            ...
            .armor(() -> TraitPack.create().armor(ModTraits.BLAST_RESISTANT.get()).build(), () -> com.ultreon.randomthingz.util.builder.ArmorMaterial.builder()
                    ...
                    .build())
            .tools(() -> TraitPack.create().tools(ModTraits.KNOCKBACK.get()).build(), () -> com.ultreon.randomthingz.util.builder.ItemTier.builder()
    ...
    BISMUTH_BRASS(builder("bismuth_brass", DEPRECATED)
    ...
    ALUMINUM_STEEL(builder("aluminum_steel")
            ...
            .armor(() -> TraitPack.create().armor(ModTraits.BLAST_RESISTANT.get()).build(), () -> com.ultreon.randomthingz.util.builder.ArmorMaterial.builder()
                    ...
                    .build())
            .tools(() -> TraitPack.create().tools(ModTraits.SHARP.get()).build(), () -> com.ultreon.randomthingz.util.builder.ItemTier.builder()
    ...
    BISMUTH_STEEL(builder("bismuth_steel", DEPRECATED)
    ...
    SIGNALUM(builder("signalum", DEPRECATED)
    ...
    ENDERIUM(builder("enderium")
            ...
            .armor(() -> TraitPack.create().armor(ModTraits.ENDER.get()).build(), () -> com.ultreon.randomthingz.util.builder.ArmorMaterial.builder()
                    ...
                    .build())
            .tools(() -> TraitPack.create().tools(ModTraits.ENDER.get()).build(), () -> com.ultreon.randomthingz.util.builder.ItemTier.builder()
    ...
    COBALT(builder("cobalt", WIP)
            .material(() -> ItemMaterial.COBALT.getIngot().get(), () -> Items.STICK)
            .armor(() -> TraitPack.create().armor(ModTraits.MAGIC_RESISTANT.get()).build(), () -> com.ultreon.randomthingz.util.builder.ArmorMaterial.builder()
    ...
    ULTRINIUM(builder("ultrinium")
            ...
            .armor(() -> TraitPack.create().armor(ModTraits.BLAST_RESISTANT.get(), ModTraits.MAGIC_RESISTANT.get(), ModTraits.FIRE_RESISTANT.get(), ModTraits.HOLY.get()).build(), () -> com.ultreon.randomthingz.util.builder.ArmorMaterial.builder()
                    ...
                    .build())
            .tools(() -> TraitPack.create().armor(ModTraits.HOLY.get(), ModTraits.WITHER.get(), ModTraits.POISON.get()).build(), () -> com.ultreon.randomthingz.util.builder.ItemTier.builder()
                    .tier(6).maxUses(65536).efficiency(9.0f).attackDamage(127.0f).enchantability(224)
    ...
    INFINITY(builder("infinity")
            ...
            .armor(() -> TraitPack.create().armor(
                    ...
                    ModTraits.RADIOACTIVE.get()).build(), () -> com.ultreon.randomthingz.util.builder.ArmorMaterial.builder()
            ...
            .tools(() -> TraitPack.create().all(
                    ...
                    ModTraits.RADIOACTIVE.get()).build(), () -> com.ultreon.randomthingz.util.builder.ItemTier.builder()
    ...
    AQUAMARINE(builder("aquamarine", WIP)
    ...
    MALACHITE(builder("malachite", WIP)
    ...
    TANZANITE(builder("tanzanite", WIP)
    ...
    private static final class Builder {
        ...
        private FeatureStatus status = NORMAL;
