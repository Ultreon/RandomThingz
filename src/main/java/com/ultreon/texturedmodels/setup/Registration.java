...
public class Registration {
    private static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, TexturedModels.MOD_ID);
    private static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, TexturedModels.MOD_ID);
    private static final DeferredRegister<TileEntityType<?>> TILES = DeferredRegister.create(ForgeRegistries.TILE_ENTITIES, TexturedModels.MOD_ID);
    //WHAT THE FACK???
    private static final DeferredRegister<ContainerType<?>> CONTAINERS = DeferredRegister.create(ForgeRegistries.CONTAINERS, TexturedModels.MOD_ID);
    ...
    private static final DeferredRegister<PointOfInterestType> POI_TYPES = DeferredRegister.create(ForgeRegistries.POI_TYPES, TexturedModels.MOD_ID);
    ...
    public static final RegistryObject<FrameBlock> FRAMEBLOCK = BLOCKS.register("frameblock", () -> new FrameBlock(Block.Properties.generate(Material.WOOD)
            ...
            .variableOpacity()
            .notSolid()));
    public static final RegistryObject<Item> FRAMEBLOCK_ITEM = ITEMS.register("frameblock", () -> new BlockItem(FRAMEBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> FRAME_WALK_THRU_ITEM = ITEMS.register("frame_walk_thru", () -> new BlockItem(FRAME_WALK_THRU.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> SLAB_FRAME_ITEM = ITEMS.register("frame_slab", () -> new BlockItem(SLAB_FRAMEBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> ILLUSION_BLOCK_ITEM = ITEMS.register("illusion_block", () -> new BlockItem(ILLUSION_BLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> BUTTON_FRAME_ITEM = ITEMS.register("frame_button", () -> new BlockItem(BUTTON_FRAMEBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> PRESSURE_PLATE_FRAME_ITEM = ITEMS.register("frame_pressure_plate", () -> new BlockItem(PRESSURE_PLATE_FRAMEBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> STAIRS_FRAME_ITEM = ITEMS.register("frame_stairs", () -> new BlockItem(STAIRS_FRAMEBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> DOOR_FRAME_ITEM = ITEMS.register("frame_door", () -> new BlockItem(DOOR_FRAMEBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> TRAPDOOR_FRAME_ITEM = ITEMS.register("frame_trapdoor", () -> new BlockItem(TRAPDOOR_FRAMEBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> FENCE_FRAME_ITEM = ITEMS.register("frame_fence", () -> new BlockItem(FENCE_FRAMEBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> BED_FRAME_ITEM = ITEMS.register("frame_bed", () -> new BlockItem(BED_FRAMEBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> WALL_FRAME_ITEM = ITEMS.register("frame_wall", () -> new BlockItem(WALL_FRAMEBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> LADDER_FRAME_ITEM = ITEMS.register("frame_ladder", () -> new BlockItem(LADDER_FRAMEBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> CHEST_FRAME_ITEM = ITEMS.register("frame_chest", () -> new BlockItem(CHEST_FRAMEBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> FENCE_GATE_FRAME_ITEM = ITEMS.register("frame_fence_gate", () -> new BlockItem(FENCE_GATE_FRAMEBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> SLOPE_FRAME_ITEM = ITEMS.register("frame_slope", () -> new BlockItem(SLOPE_FRAMEBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> EDGED_SLOPE_FRAME_ITEM = ITEMS.register("frame_edged_slope", () -> new BlockItem(EDGED_SLOPE_FRAMEBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> SLAB_ILLUSION_ITEM = ITEMS.register("illusion_slab", () -> new BlockItem(SLAB_ILLUSIONBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> BUTTON_ILLUSION_ITEM = ITEMS.register("illusion_button", () -> new BlockItem(BUTTON_ILLUSIONBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> PRESSURE_PLATE_ILLUSION_ITEM = ITEMS.register("illusion_pressure_plate", () -> new BlockItem(PRESSURE_PLATE_ILLUSIONBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> STAIRS_ILLUSION_ITEM = ITEMS.register("illusion_stairs", () -> new BlockItem(STAIRS_ILLUSIONBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> DOOR_ILLUSION_ITEM = ITEMS.register("illusion_door", () -> new BlockItem(DOOR_ILLUSIONBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> TRAPDOOR_ILLUSION_ITEM = ITEMS.register("illusion_trapdoor", () -> new BlockItem(TRAPDOOR_ILLUSIONBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> FENCE_ILLUSION_ITEM = ITEMS.register("illusion_fence", () -> new BlockItem(FENCE_ILLUSIONBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> BED_ILLUSION_ITEM = ITEMS.register("illusion_bed", () -> new BlockItem(BED_ILLUSIONBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> WALL_ILLUSION_ITEM = ITEMS.register("illusion_wall", () -> new BlockItem(WALL_ILLUSIONBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> LADDER_ILLUSION_ITEM = ITEMS.register("illusion_ladder", () -> new BlockItem(LADDER_ILLUSIONBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> CHEST_ILLUSION_ITEM = ITEMS.register("illusion_chest", () -> new BlockItem(CHEST_ILLUSIONBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> FENCE_GATE_ILLUSION_ITEM = ITEMS.register("illusion_fence_gate", () -> new BlockItem(FENCE_GATE_ILLUSIONBLOCK.get(), new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS)));
    ...
    public static final RegistryObject<Item> HAMMER = ITEMS.register("hammer", () -> new Item(new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS).maxStackSize(1)));
    public static final RegistryObject<Item> TEXTURE_WRENCH = ITEMS.register("texture_wrench", () -> new Item(new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS).maxStackSize(1)));
    public static final RegistryObject<Item> CHISEL = ITEMS.register("chisel", () -> new Item(new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS).maxStackSize(1)));
    public static final RegistryObject<Item> PAINTBRUSH = ITEMS.register("paintbrush", () -> new Item(new Item.Properties().group(TexturedModels.QTexturedModelsItemGroup.QTEXTUREMODELS).maxStackSize(1)));
