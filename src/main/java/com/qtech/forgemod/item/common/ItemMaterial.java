...
import com.qtech.forgemod.block.machines.MetalBlock;
import com.qtech.forgemod.world.gen.ores.DefaultOre;
import com.qtech.forgemod.world.gen.ores.IOre;
import com.qtech.forgemod.world.gen.ores.Ores;
...
public enum ItemMaterial implements IItemMaterial {
    // Metals
    ...
    TUNGSTEN(builderAlloy("tungsten", 2)),
    ...
    AQUAMARINE(builder("aquamarine").ore(Ores.AQUAMARINE).storageBlock(2)),
