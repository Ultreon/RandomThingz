package com.qtech.forgemod.item.common;

import com.qtech.forgemod.QForgeMod;
import com.qtech.forgemod.item.tools.ModTraits;
import com.qtech.forgemod.item.tools.SwordTool;
...
import com.qtech.forgemod.item.EucalyptusLeafItem;
import com.qtech.forgemod.item.LegendaryEnderPearlItem;
import com.qtech.forgemod.item.advanced.AdvancedBowItem;
import com.qtech.forgemod.item.debug.DebugItem;
import com.qtech.forgemod.item.energy.BatteryItem;
import com.qtech.forgemod.item.energy.WrenchItem;
import com.qtech.forgemod.item.fluid.CanisterItem;
import com.qtech.forgemod.item.fluid.EmptyCanisterItem;
import com.qtech.forgemod.item.fluid.HandPumpItem;
import com.qtech.forgemod.item.fluid.NoPlaceBucketItem;
import com.qtech.forgemod.item.UnstableInfinityIngot;
import com.qtech.forgemod.item.specials.KillSwitchItem;
import com.qtech.forgemod.item.specials.KnifeItem;
import com.qtech.forgemod.item.specials.MagnetItem;
import com.qtech.forgemod.item.tools.*;
import com.qtech.forgemod.item.type.IngotOrDustItem;
import com.qtech.forgemod.item.type.IngredientItem;
import com.qtech.forgemod.item.type.SliceableItem;
import com.qtech.forgemod.item.upgrades.MachineUpgrades;
import com.qtech.forgemod.item.wand.*;
import com.qtech.forgemod.modules.ui.ModItemGroups;
import com.qtech.forgemod.util.builder.ArmorMaterial;
import com.qtech.forgemod.util.builder.ItemTier;
import com.qtech.forgemod.util.color.ColorGetter;
...
public final class ModItems {
    ...
    public static final ItemRegistryObject<SliceableItem> CHEESE = register("cheese", () -> new SliceableItem(new Item.Properties().group(ItemGroup.FOOD).food(new Food.Builder().hunger(2).saturation(0.3f).build()), (stack) -> new ItemStack(CHEESE_SLICE, stack.getCount() * 6)));
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public static final ItemRegistryObject<KnifeItem> KNIFE = register("knife", () -> new KnifeItem(net.minecraft.item.ItemTier.IRON, new Item.Properties().group(ItemGroup.TOOLS).maxDamage(4)));
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public static final IArmorMaterial enderiumArmorMaterial = ArmorMaterial.builder()
            .name(QForgeMod.MOD_ID + ":enderium")
            .maxDamageFactor(34)
    ...
    public static final IArmorMaterial electrumArmorMaterial = ArmorMaterial.builder()
            .name(QForgeMod.MOD_ID + ":electrum")
            .maxDamageFactor(34)
            .damageReduction(new int[]{4, 10, 13, 7})
            .enchantability(41)
            .knockbackResistance(3f)
    ...
    public static final IArmorMaterial redstoneArmorMaterial = ArmorMaterial.builder()
            .name(QForgeMod.MOD_ID + ":redstone")
            .maxDamageFactor(8)
    ...
    public static final IArmorMaterial tungstenArmorMaterial = ArmorMaterial.builder()
            .name(QForgeMod.MOD_ID + ":tungsten")
            .maxDamageFactor(42)
    ...
    public static final IArmorMaterial platinumArmorMaterial = ArmorMaterial.builder()
            .name(QForgeMod.MOD_ID + ":platinum")
            .maxDamageFactor(46)
            .damageReduction(new int[]{3, 6, 8, 4})
            .enchantability(4)
    ...
    public static final IArmorMaterial amethystArmorMaterial = ArmorMaterial.builder()
            .name(QForgeMod.MOD_ID + ":amethyst")
            .maxDamageFactor(21)
            .damageReduction(new int[]{2, 5, 7, 3})
            .enchantability(31)
            .knockbackResistance(1f)
    ...
    public static final IArmorMaterial aquamarineArmorMaterial = ArmorMaterial.builder()
            .name(QForgeMod.MOD_ID + ":aquamarine")
            .maxDamageFactor(21)
    ...
    public static final IArmorMaterial malachiteArmorMaterial = ArmorMaterial.builder()
            .name(QForgeMod.MOD_ID + ":malachite")
            .maxDamageFactor(21)
            .damageReduction(new int[]{2, 4, 6, 2})
            .enchantability(31)
            .knockbackResistance(1f)
    ...
    public static final IArmorMaterial tanzaniteArmorMaterial = ArmorMaterial.builder()
            .name(QForgeMod.MOD_ID + ":tanzanite")
            .maxDamageFactor(19)
    ...
    public static final IArmorMaterial obsidianArmorMaterial = ArmorMaterial.builder()
            .name(QForgeMod.MOD_ID + ":obsidian")
            .maxDamageFactor(175)
...
//            .name(QForgeMod.MOD_ID + ":ultrinium")
...
//            .name(QForgeMod.MOD_ID + ":infinity")
...
//            .repairMaterial(() -> Ingredient.fromItems(OreMaterial.SILVER.getIngot().orElseThrow(() -> new NullPointerException("Silver ingot not found in OreMaterial class.")))).build();
    ...
    public static final IItemTier REDSTONE_ITEM_TIER = ItemTier.builder()
            ...
            .repairMaterial(() -> Ingredient.fromItems(ItemMaterial.REDSTONE_ALLOY.getIngot().orElseThrow(() -> new NullPointerException("Redstone Alloy ingot not found in OreMaterial class.")))).build();
    ...
    public static final IItemTier TUNGSTEN_ITEM_TIER = ItemTier.builder()
            ...
            .repairMaterial(() -> Ingredient.fromItems(ItemMaterial.TUNGSTEN.getIngot().orElseThrow(() -> new NullPointerException("Tungsten ingot not found in OreMaterial class.")))).build();
