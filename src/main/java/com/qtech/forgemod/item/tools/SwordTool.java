...
public class SwordTool extends SwordItem implements ITool {
    private final Supplier<AbstractTrait[]> traits;
    private final float attackDamage;
    private final Multimap<Attribute, AttributeModifier> toolAttributes;

    public SwordTool(IItemTier tier, int attackDamageIn, float attackSpeedIn, Properties builderIn, Supplier<AbstractTrait[]> traits) {
