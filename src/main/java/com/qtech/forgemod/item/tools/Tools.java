...
import com.qtech.forgemod.commons.exceptions.UnidentifiedObjectException;
import com.qtech.forgemod.init.Registration;
import com.qtech.forgemod.item.common.ItemMaterial;
import com.qtech.forgemod.item.tools.types.*;
...
public enum Tools {
    ...
    COMPRESSED_IRON(builder("compressed_iron")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QForgeMod.MOD_ID + ":compressed_iron")
                    .maxDamageFactor(17)
...
//                    .repairMaterial(() -> Ingredient.fromItems(ModItems.TUNGSTEN_INGOT)).build())),
    ...
    ALUMINUM(builder("aluminum")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QForgeMod.MOD_ID + ":aluminum")
                    .maxDamageFactor(13)
                    .damageReduction(new int[]{2, 5, 6, 2})
                    .enchantability(10)
                    .knockbackResistance(0f)
    ...
    BISMUTH_BRASS(builder("bismuth_brass")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QForgeMod.MOD_ID + ":bismuth_brass")
                    .maxDamageFactor(16)
                    .damageReduction(new int[]{2, 5, 6, 2})
                    .enchantability(10)
                    .knockbackResistance(0f)
    ...
    ALUMINUM_STEEL(builder("aluminum_steel")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QForgeMod.MOD_ID + ":aluminum_steel")
                    .maxDamageFactor(17)
                    .damageReduction(new int[]{2, 5, 6, 2})
                    .enchantability(9)
                    .knockbackResistance(0f)
    ...
    BISMUTH_STEEL(builder("bismuth_steel")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QForgeMod.MOD_ID + ":bismuth_steel")
                    .maxDamageFactor(18)
                    .damageReduction(new int[]{2, 5, 6, 2})
                    .enchantability(10)
                    .knockbackResistance(0f)
    ...
    SIGNALUM(builder("signalum")
            ...
            .armor(() -> ArmorMaterial.builder()
                    .name(QForgeMod.MOD_ID + ":signalum")
                    .maxDamageFactor(14)
                    .damageReduction(new int[]{2, 5, 6, 2})
                    .enchantability(10)
                    .knockbackResistance(0f)
