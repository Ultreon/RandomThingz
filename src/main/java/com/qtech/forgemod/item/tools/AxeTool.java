...
public class AxeTool extends AxeItem implements ITool {
    private final Supplier<AbstractTrait[]> traits;
    private final double attackDamage;
    private final Multimap<Attribute, AttributeModifier> toolAttributes;

    public AxeTool(IItemTier tier, double attackDamageIn, double attackSpeedIn, Properties builderIn, Supplier<AbstractTrait[]> traits) {
