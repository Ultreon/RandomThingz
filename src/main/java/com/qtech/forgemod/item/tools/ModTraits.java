...
import com.qtech.forgemod.item.tools.trait.*;
...
public final class ModTraits {
    ...
    public static final DeferredRegister<AbstractTrait> REGISTRY = DeferredRegister.create(AbstractTrait.class, QForgeMod.MOD_ID);
