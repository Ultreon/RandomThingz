...
import com.qtech.forgemod.modules.items.objects.tools.types.BroadswordItem;
...
public class BroadswordTool extends BroadswordItem implements ITool {
    ...
    public BroadswordTool(IItemTier tier, int attackDamageIn, float attackSpeedIn, Properties builderIn, Supplier<AbstractTrait[]> traits) {
