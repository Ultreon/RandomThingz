...
import com.qtech.forgemod.modules.items.objects.EucalyptusLeafItem;
import com.qtech.forgemod.modules.items.objects.LegendaryEnderPearlItem;
import com.qtech.forgemod.modules.items.objects.advanced.AdvancedBowItem;
import com.qtech.forgemod.modules.items.objects.debug.DebugItem;
import com.qtech.forgemod.modules.items.objects.energy.BatteryItem;
import com.qtech.forgemod.modules.items.objects.energy.WrenchItem;
import com.qtech.forgemod.modules.items.objects.fluid.CanisterItem;
import com.qtech.forgemod.modules.items.objects.fluid.EmptyCanisterItem;
import com.qtech.forgemod.modules.items.objects.fluid.HandPumpItem;
import com.qtech.forgemod.modules.items.objects.fluid.NoPlaceBucketItem;
import com.qtech.forgemod.modules.items.objects.overpowered.UnstableInfinityIngot;
import com.qtech.forgemod.modules.items.objects.specials.KillSwitchItem;
import com.qtech.forgemod.modules.items.objects.specials.KnifeItem;
import com.qtech.forgemod.modules.items.objects.specials.MagnetItem;
import com.qtech.forgemod.modules.items.objects.tools.*;
import com.qtech.forgemod.modules.items.objects.type.IngotOrDustItem;
import com.qtech.forgemod.modules.items.objects.type.IngredientItem;
import com.qtech.forgemod.modules.items.objects.type.SliceableItem;
import com.qtech.forgemod.modules.items.objects.upgrades.MachineUpgrades;
import com.qtech.forgemod.modules.items.objects.wand.*;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public static final IArmorMaterial aquamarineArmorMaterial = ArmorMaterial.builder()
            .name(QForgeMod.modId + ":aquamarine")
            .maxDamageFactor(21)
    ...
    public static final IArmorMaterial malachiteArmorMaterial = ArmorMaterial.builder()
            .name(QForgeMod.modId + ":malachite")
            .maxDamageFactor(21)
            .damageReduction(new int[]{2, 4, 6, 2})
            .enchantability(31)
            .knockbackResistance(1f)
    ...
    public static final IArmorMaterial tanzaniteArmorMaterial = ArmorMaterial.builder()
            .name(QForgeMod.modId + ":tanzanite")
            .maxDamageFactor(19)
