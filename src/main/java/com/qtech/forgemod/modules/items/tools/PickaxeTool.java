...
public class PickaxeTool extends PickaxeItem implements ITool {
    private final Supplier<AbstractTrait[]> traits;
    private final double attackDamage;
    private final Multimap<Attribute, AttributeModifier> toolAttributes;

    public PickaxeTool(IItemTier tier, double attackDamageIn, double attackSpeedIn, Properties builderIn, Supplier<AbstractTrait[]> traits) {
    ...
    public Set<ToolType> getQfmToolTypes() {
        return new HashSet<>(Arrays.asList(ToolType.PICKAXE));
    }
