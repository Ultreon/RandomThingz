...
import com.qtech.forgemod.modules.items.objects.tools.types.ExcavatorItem;
...
public class ExcavatorTool extends ExcavatorItem implements ITool {
    private final Supplier<AbstractTrait[]> traits;
    private final float attackDamage;
    private final Multimap<Attribute, AttributeModifier> toolAttributes;

    public ExcavatorTool(IItemTier tier, float attackDamageIn, float attackSpeedIn, Properties builderIn, Supplier<AbstractTrait[]> traits) {
