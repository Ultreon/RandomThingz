...
import com.qtech.forgemod.modules.environment.client.model.MoobloomModel;
import com.qtech.forgemod.modules.environment.entities.MoobloomEntity;
...
//        this.addLayer(new MoobloomFlowerLayer<>(this));
    ...
    public @NotNull ResourceLocation getEntityTexture(@NotNull MoobloomEntity entity) {
        return new ResourceLocation(QForgeMod.modId, "textures/entity/cow/moobloom/" + entity.getMoobloomType().getFilename());
    }
}
