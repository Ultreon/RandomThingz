...
import com.qtech.forgemod.modules.environment.client.model.CluckshroomModel;
import com.qtech.forgemod.modules.environment.entities.CluckshroomEntity;
...
public class CluckshroomRenderer extends MobRenderer<CluckshroomEntity, CluckshroomModel<CluckshroomEntity>> {
    private static final ResourceLocation CLUCKSHROOM_TEXTURE = new ResourceLocation(QForgeMod.modId, "textures/entity/cluckshroom.png");
