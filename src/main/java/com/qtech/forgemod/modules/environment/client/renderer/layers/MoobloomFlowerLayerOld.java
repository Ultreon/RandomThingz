...
@Deprecated
@OnlyIn(Dist.CLIENT)
public class MoobloomFlowerLayerOld<T extends MoobloomEntityOld> extends LayerRenderer<T, CowModel<T>> {
    public MoobloomFlowerLayerOld(IEntityRenderer<T, CowModel<T>> rendererIn) {
        super(rendererIn);
    }
