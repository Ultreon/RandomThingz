package com.qtech.forgemod.modules.environment.client.renderer;

import com.mojang.blaze3d.matrix.MatrixStack;
import com.qtech.forgemod.QForgeMod;
import com.qtech.forgemod.modules.environment.client.model.FreeEndermanModel;
import com.qtech.forgemod.modules.environment.client.renderer.layers.CustomEndermanEyesLayer;
import com.qtech.forgemod.modules.environment.client.renderer.layers.CustomHeldBlockLayer;
import com.qtech.forgemod.modules.environment.entities.IceEndermanEntity;
...
public class IceEndermanRenderer extends MobRenderer<IceEndermanEntity, FreeEndermanModel<IceEndermanEntity>> {
    private static final ResourceLocation ENDERMAN_TEXTURES = new ResourceLocation(QForgeMod.modId, "textures/entity/enderman/ice.png");

    private static final RenderType RENDER_TYPE = RenderType.getEyes(new ResourceLocation(QForgeMod.modId, "textures/entity/enderman/ice_eyes.png"));
