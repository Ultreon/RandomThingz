...
import com.qtech.forgemod.modules.environment.client.renderer.layers.GlowSquidGlowLayer;
...
public class GlowSquidRenderer extends MobRenderer<GlowSquidEntity, SquidModel<GlowSquidEntity>> {
     ...
     * Glow squid texture.
     */
    private static final ResourceLocation GLOW_SQUID_TEXTURE = new ResourceLocation(QForgeMod.modId, "textures/entity/squid/glow_squid.png");
