...
import com.qtech.forgemod.modules.environment.client.model.FreeCreeperModel;
import com.qtech.forgemod.modules.environment.client.renderer.layers.CustomCreeperChargeLayer;
import com.qtech.forgemod.modules.environment.entities.FireCreeperEntity;
...
public class FireCreeperRenderer extends MobRenderer<FireCreeperEntity, FreeCreeperModel<FireCreeperEntity>> {
    private static final ResourceLocation CREEPER_TEXTURES = new ResourceLocation(QForgeMod.modId, "textures/entity/creeper/fire.png");
