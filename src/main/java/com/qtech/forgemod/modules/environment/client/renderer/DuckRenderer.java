...
import com.qtech.forgemod.modules.environment.client.model.FreeChickenModel;
import com.qtech.forgemod.modules.environment.entities.DuckEntity;
...
public class DuckRenderer extends MobRenderer<DuckEntity, FreeChickenModel<DuckEntity>> {
    private static final ResourceLocation DUCK_TEXTURES = new ResourceLocation(QForgeMod.modId, "textures/entity/duck.png");
