...
import com.qtech.forgemod.modules.ui.widgets.Progressbar;
...
//            urlConnection.connect();
            ...
            QForgeMod.LOGGER.info("Total download size is: " + this.totalSize);

            QForgeMod.LOGGER.info("Loading input stream for connection...");
            // Url Input stream
            ...
            if (!updateFolder.exists()) {
                QForgeMod.LOGGER.info("Update folder doesn't exists, creating one...");
                updateFolder.mkdirs();
            }
            ...
            QForgeMod.LOGGER.info("Creating file...");
            ...
            QForgeMod.LOGGER.info("Download started!");
            QForgeMod.LOGGER.info("Block size: " + currentBlockSize);
