package com.qtech.forgemod.modules.tiles.blocks.machines.itempipe;

import com.google.common.collect.Maps;
import com.qtech.forgemod.QForgeMod;
import com.qtech.forgemod.api.IWrenchable;
import com.qtech.forgemod.util.ItemCapabilityUtils;
...
public class ItemPipeBlock extends SixWayBlock implements IWrenchable {
    ...
    public BlockState updatePostPlacement(BlockState stateIn, Direction facing, BlockState facingState, IWorld dimensionIn, BlockPos currentPos, BlockPos facingPos) {
        if (dimensionIn.getTileEntity(facingPos) instanceof ItemPipeTileEntity)
