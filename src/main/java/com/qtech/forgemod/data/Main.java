...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        mods.add(QForgeMod.MOD_ID);
        existingFileHelper = new ExistingFileHelper(Collections.singletonList(Paths.get("src/main/resources")), new HashSet<>(), true);
        GatherDataEvent event = new GatherDataEvent(null, dataGeneratorConfig.makeGenerator(p -> dataGeneratorConfig.isFlat() ? p : p.resolve(QForgeMod.MOD_ID), true), dataGeneratorConfig, existingFileHelper);
