...
import com.qtech.forgemod.world.gen.ores.configs.ChancedOreConfig;
import com.qtech.forgemod.world.gen.ores.configs.DefaultOreConfig;
...
public final class Ores {
    ...
    // Nether ore.
    public static final NetherOre COBALT = new NetherOre("cobalt", () -> ItemMaterial.COBALT, 20, 4, new DefaultOreConfig(128, 2, 0, 48));
