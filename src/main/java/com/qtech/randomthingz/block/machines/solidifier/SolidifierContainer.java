package com.qtech.randomthingz.block.machines.solidifier;

import com.qsoftware.modlib.silentlib.inventory.SlotOutputOnly;
import com.qsoftware.modlib.silentlib.util.InventoryUtils;
import com.qtech.randomthingz.block.machines.AbstractMachineBaseContainer;
    ...
    public ItemStack transferStackInSlot(PlayerEntity playerIn, int index) {
        ...
        if (slot != null && slot.hasStack()) {
            ...
            if (index == 1 || index == 2) {
                ...
                if (com.qtech.randomthingz.util.InventoryUtils.isEmptyFluidContainer(itemstack1) || com.qtech.randomthingz.util.InventoryUtils.isFilledFluidContainer(itemstack1)) {
