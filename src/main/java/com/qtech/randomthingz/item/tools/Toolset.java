...
import com.qtech.randomthingz.commons.exceptions.UnidentifiedObjectException;
import com.qtech.randomthingz.item.common.ItemMaterial;
import com.qtech.randomthingz.item.common.ModItems;
import com.qtech.randomthingz.item.tools.types.*;
...
import static com.qtech.randomthingz.commons.FeatureStatus.*;
...
public enum Toolset {
    ...
    STEEL(builder("steel")
            ...
            .armor(() -> TraitPack.create().armor(ModTraits.BLAST_RESISTANT.get()).build(), () -> ArmorMaterial.builder()
                    ...
                    .build())
            .tools(() -> TraitPack.create().tools(ModTraits.KNOCKBACK.get()).build(), () -> ItemTier.builder()
