...
public enum Tools {
    ...
    AMETHYST(builder("amethyst")
            .material(ModItems.AMETHYST, () -> Items.STICK)
            .armor(() -> ArmorMaterial.builder()
    ...
    BERYL(builder("beryl")
            .material(ModItems.BERYL, () -> Items.STICK)
            .armor(() -> ArmorMaterial.builder()
    ...
    AMBER(builder("amber")
            .material(ModItems.AMBER, () -> Items.STICK)
            .armor(() -> ArmorMaterial.builder()
    ...
    MALACHITE(builder("malachite")
            .material(ModItems.MALACHITE, () -> Items.STICK)
            .armor(() -> ArmorMaterial.builder()
    ...
    PERIDOT(builder("peridot")
            .material(ModItems.PERIDOT, () -> Items.STICK)
            .armor(() -> ArmorMaterial.builder()
    ...
    SAPHIRE(builder("saphire")
            .material(ModItems.SAPHIRE, () -> Items.STICK)
            .armor(() -> ArmorMaterial.builder()
    ...
    RUBY(builder("ruby")
            .material(ModItems.RUBY, () -> Items.STICK)
            .armor(() -> ArmorMaterial.builder()
    ...
    TANZANITE(builder("tanzanite")
            .material(ModItems.TANZANITE, () -> Items.STICK)
            .armor(() -> ArmorMaterial.builder()
