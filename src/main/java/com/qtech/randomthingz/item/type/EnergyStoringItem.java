...
import com.qtech.randomthingz.capability.EnergyStorageItemImpl;
import com.qtech.randomthingz.client.hud.HudItem;
import com.qtech.randomthingz.util.GraphicsUtil;
...
public class EnergyStoringItem extends HudItem {
    public static final ResourceLocation CHARGE = new ResourceLocation(RandomThingz.MOD_ID, "charge");
