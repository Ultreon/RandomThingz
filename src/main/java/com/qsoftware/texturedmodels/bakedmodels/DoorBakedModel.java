    ...
    public List<BakedQuad> getMimicQuads(@Nullable BlockState state, @Nullable Direction side, @Nonnull Random rand, @Nonnull IModelData extraData, IBakedModel model) {
        ...
        if (mimic != null && state != null && extraData.getData(FrameBlockTile.DESIGN) != null && extraData.getData(FrameBlockTile.DESIGN_TEXTURE) != null) {
            ...
            if (design == 0) {
                if (northSide) {
                    if (half == lower) {
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(0f, 4 / 16f, 0, 1f, 13 / 16f, 1f, texture, tintIndex));
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(12 / 16f, 1f, 0, 1f, 13 / 16f, 1f, texture, tintIndex));
                        ...
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(4 / 16f, 12 / 16f, 0f, 4 / 16f, 13 / 16f, 1f, texture, tintIndex));
                    }
                    if (half == upper) {
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(0f, 4 / 16f, 0, 1f, 13 / 16f, 1f, texture, tintIndex));
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(12 / 16f, 1f, 0, 1f, 13 / 16f, 1f, texture, tintIndex));
                        ...
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(4 / 16f, 12 / 16f, 12 / 16f, 1f, 13 / 16f, 1f, texture, tintIndex));
                    }
                } else if (westSide) {
                    if (half == lower) {
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(13 / 16f, 1f, 0, 1f, 12 / 16f, 1f, texture, tintIndex));
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(13 / 16f, 1f, 0, 1f, 0f, 4 / 16f, texture, tintIndex));
                        ...
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(13 / 16f, 1f, 0f, 4 / 16f, 4 / 16f, 12 / 16f, texture, tintIndex));
                    }
                    if (half == upper) {
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(13 / 16f, 1f, 0, 1f, 12 / 16f, 1f, texture, tintIndex));
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(13 / 16f, 1f, 0, 1f, 0f, 4 / 16f, texture, tintIndex));
                        ...
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(13 / 16f, 1f, 12 / 16f, 1f, 4 / 16f, 12 / 16f, texture, tintIndex));
                    }
                } else if (eastSide) {
                    if (half == lower) {
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(0f, 3 / 16f, 0, 1f, 12 / 16f, 1f, texture, tintIndex));
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(0f, 3 / 16f, 0, 1f, 0f, 4 / 16f, texture, tintIndex));
                        ...
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(0f, 3 / 16f, 0f, 4 / 16f, 4 / 16f, 12 / 16f, texture, tintIndex));
                    }
                    if (half == upper) {
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(0f, 3 / 16f, 0, 1f, 12 / 16f, 1f, texture, tintIndex));
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(0f, 3 / 16f, 0, 1f, 0f, 4 / 16f, texture, tintIndex));
                        ...
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(0f, 3 / 16f, 12 / 16f, 1f, 4 / 16f, 12 / 16f, texture, tintIndex));
                    }
                } else {
                    if (half == lower) {
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(0f, 4 / 16f, 0, 1f, 0f, 3 / 16f, texture, tintIndex));
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(12 / 16f, 1f, 0, 1f, 0f, 3 / 16f, texture, tintIndex));
                        ...
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(4 / 16f, 12 / 16f, 0f, 4 / 16f, 0f, 3 / 16f, texture, tintIndex));
                    }
                    if (half == upper) {
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(0f, 4 / 16f, 0, 1f, 0f, 3 / 16f, texture, tintIndex));
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(12 / 16f, 1f, 0, 1f, 0f, 3 / 16f, texture, tintIndex));
                        ...
                        quads.addAll(com.qsoftware.texturedmodels.util.ModelHelper.createCuboid(4 / 16f, 12 / 16f, 12 / 16f, 1f, 0f, 3 / 16f, texture, tintIndex));
                    }
                }
            }
            if (design == 3) {
