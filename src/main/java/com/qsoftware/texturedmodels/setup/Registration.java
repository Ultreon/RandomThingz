...
import com.qsoftware.texturedmodels.block.*;
import com.qsoftware.texturedmodels.container.ChestFrameContainer;
import com.qsoftware.texturedmodels.container.IllusionChestContainer;
...
public class Registration {
    ...
    public static final RegistryObject<FrameBlock> FRAMEBLOCK_WALK_THRU = BLOCKS.register("frameblock_walk_thru", () -> new FrameBlock(Block.Properties.create(Material.WOOD)
            .sound(SoundType.WOOD)
            .hardnessAndResistance(0.4f)
            .harvestTool(ToolType.AXE)
            .harvestLevel(0)
    ...
    public static final RegistryObject<Item> FRAMEBLOCK_WALK_THRU_ITEM = ITEMS.register("frameblock_walk_thru", () -> new BlockItem(FRAMEBLOCK_WALK_THRU.get(), new Item.Properties().group(BlockCarpentryMain.BlockCarpentryItemGroup.BLOCK_CARPENTRY)));
    public static final RegistryObject<TileEntityType<FrameBlockTile>> FRAMEBLOCK_WALK_THRU_TILE = TILES.register("frameblock_walk_thru", () -> TileEntityType.Builder.create(FrameBlockTile::new, FRAMEBLOCK_WALK_THRU.get()).build(null));
