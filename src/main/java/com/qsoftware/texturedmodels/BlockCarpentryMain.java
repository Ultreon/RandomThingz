package com.qsoftware.texturedmodels;

import com.qsoftware.texturedmodels.setup.Registration;
import com.qsoftware.texturedmodels.setup.RenderSetup;
import com.qsoftware.texturedmodels.setup.config.BCModConfig;
import com.qsoftware.texturedmodels.util.BlockColorHandler;
...
import static com.qsoftware.texturedmodels.BlockCarpentryMain.MOD_ID;
...
public class BlockCarpentryMain
{
    ...
    public static class BlockCarpentryItemGroup extends ItemGroup {
        ...
        public static final BlockCarpentryItemGroup BLOCK_CARPENTRY = new BlockCarpentryItemGroup(ItemGroup.GROUPS.length,"qtexturedmodels");
