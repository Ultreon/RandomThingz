...
//        sb.append(TextFormatting.DARK_AQUA).append(text);
    ...
    public static String format(Object obj) {
        ...
        if (obj == null) {
            ...
            sb.append(TextFormatting.GRAY).append(rl.getNamespace());
            ...
            StaticClass c = (StaticClass) obj;
            return TextFormatting.YELLOW + "JavaClassStatics" + TextFormatting.GRAY + "[" + TextFormatting.DARK_GREEN + c.getRepresentedClass().getName() + TextFormatting.GRAY + "]";
        } else {
