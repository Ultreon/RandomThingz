package com.qsoftware.forgemod.modules.tiles.blocks.machines.alloysmelter;
...
public class AlloySmelterBlock extends AbstractMachineBlock {
    public AlloySmelterBlock(MachineTier tier) {
        super(tier, AbstractBlock.Properties.generate(Material.IRON).hardnessAndResistance(6.0f, 20.0f).sound(SoundType.METAL));
    }
