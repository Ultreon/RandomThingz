package com.qsoftware.forgemod.modules.tiles.blocks.machines.crusher;
...
public class CrusherBlock extends AbstractMachineBlock {
    public CrusherBlock(MachineTier tier) {
        super(tier, AbstractBlock.Properties.generate(Material.IRON).hardnessAndResistance(6, 20).sound(SoundType.METAL));
    }
