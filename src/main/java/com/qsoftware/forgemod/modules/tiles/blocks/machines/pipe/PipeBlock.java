package com.qsoftware.forgemod.modules.tiles.blocks.machines.pipe;
...
import com.qsoftware.forgemod.modules.tiles.blocks.machines.itempipe.ItemPipeNetworkManager;
import com.qsoftware.forgemod.modules.tiles.blocks.machines.itempipe.ItemPipeTileEntity;
...
public class PipeBlock extends SixWayBlock implements IWrenchable {
    ...
    public ActionResultType onWrench(ItemUseContext context) {
        ...
        if (side != null) {
            ...
            Block otherBlock = dimension.getBlockState(pos.offset(side)).getBlock();
    ...
    public BlockState updatePostPlacement(BlockState stateIn, Direction facing, BlockState facingState, IWorld dimensionIn, BlockPos currentPos, BlockPos facingPos) {
        if (dimensionIn.getTileEntity(facingPos) instanceof PipeTileEntity)
