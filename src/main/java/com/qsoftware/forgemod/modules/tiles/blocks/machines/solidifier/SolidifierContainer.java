package com.qsoftware.forgemod.modules.tiles.blocks.machines.solidifier;

import com.qsoftware.forgemod.modules.ui.ModMachineContainers;
import com.qsoftware.forgemod.modules.tiles.blocks.machines.AbstractMachineBaseContainer;
    ...
    public ItemStack transferStackInSlot(PlayerEntity playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index == 1 || index == 2) {
                ...
                if (com.qsoftware.forgemod.util.InventoryUtils.isEmptyFluidContainer(itemstack1) || com.qsoftware.forgemod.util.InventoryUtils.isFilledFluidContainer(itemstack1)) {
