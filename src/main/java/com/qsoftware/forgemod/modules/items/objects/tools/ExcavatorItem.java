...
//                serverInventoryTick(stack, worldIn, player);
//            } else {
//                clientInventoryTick(stack, worldIn, player);
//            }
//        }
//    }
//
//    private void serverInventoryTick(ItemStack stack, World worldIn, PlayerEntity entityIn) {
//
//    }
//
//    @SuppressWarnings("ConstantConditions")
//    private void clientInventoryTick(ItemStack stack, World worldIn, PlayerEntity entityIn) {
//        if (entityIn instanceof ClientPlayerEntity) {
//            ClientPlayerEntity player = (ClientPlayerEntity) entityIn;
//            Minecraft mc = Minecraft.getInstance();
//
//            if (player.isHandActive() && player.isServerWorld()) {
...
//                            damageBlock(worldIn, blockpos, mc, player, blockraytraceresult);
//                        } else {
