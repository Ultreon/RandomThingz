...
import com.qsoftware.forgemod.modules.entities.renderer.layers.GlowSquidGlowLayer;
import com.qsoftware.forgemod.modules.entities.objects.GlowSquidEntity;
...
public class GlowSquidRenderer extends MobRenderer<GlowSquidEntity, SquidModel<GlowSquidEntity>> {
     ...
     * Glow squid texture.
     */
    private static final ResourceLocation GLOW_SQUID_TEXTURE = new ResourceLocation(QForgeMod.MOD_ID, "textures/entity/squid/glow_squid.png");
