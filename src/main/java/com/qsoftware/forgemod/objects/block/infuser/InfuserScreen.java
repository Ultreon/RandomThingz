...
public class InfuserScreen extends AbstractMachineBaseScreen<InfuserContainer> {
    public static final ResourceLocation TEXTURE = QForgeUtils.getId("textures/gui/infuser.png");
    ...
    protected void renderHoveredTooltip(MatrixStack matrixStack, int x, int y) {
        if (isPointInRegion(29, 17, 13, 51, x, y)) {
            renderTooltip(matrixStack, TextUtil.fluidWithMax(container.getFluidInTank(0), InfuserTileEntity.TANK_CAPACITY), x, y);
        }
