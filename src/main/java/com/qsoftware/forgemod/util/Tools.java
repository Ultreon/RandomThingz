...
public class Tools {
    ...
    public static String translateDimension(String dim) {
        Map<String, String> dims = GravestoneConfig.dimensionNames;
    ...
    public static String timeToString(long time) {
        ...
        SimpleDateFormat sdf = new SimpleDateFormat(GravestoneConfig.dateFormat);
    ...
    public static Block getBlock(String name) {
        try {
            ...
            if (split.length == 2) {
                ...
                if (isAirBlock(Objects.requireNonNull(b))) {
                    return null;
                } else {
                    return b;
                }
