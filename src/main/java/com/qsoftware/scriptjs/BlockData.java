...
public class BlockData implements Formattable {
    ...
    public com.qsoftware.scriptjs.BlockState getState() {
        return new com.qsoftware.scriptjs.BlockState(state);
    }
    ...
    public float getPlayerRelativeBlockHardness(ServerPlayer player) {
    ...
    public boolean canBeReplacedByLeaves(ServerPlayer player) {
    ...
    public void setBlock(Block block) {
        if (worldReader instanceof World) {
            World world = (World) worldReader;
            com.qsoftware.scriptjs.BlockState defaultState = block.getDefaultState();
    ...
    public void setBlockState(com.qsoftware.scriptjs.BlockState block) {
        if (worldReader instanceof World) {
            World world = (World) worldReader;
    ...
    public String toString() {
        return CommonScriptJSUtils.formatClassRaw("BlockData", getPos());
    }

    public String toFormattedString() {
        return CommonScriptJSUtils.formatClass("BlockData", getPos());
    }
}
