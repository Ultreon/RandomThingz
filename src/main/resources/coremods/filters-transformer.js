...
function patch_CreativeScreen_setCurrentCreativeTab(method) {
    ...
    if(node !== null)
    {
        method.instructions.insert(node, new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "com/ultreon/filters/Events", "onCreativeTabChange", "(Lnet/minecraft/client/gui/screen/inventory/CreativeScreen;Lnet/minecraft/item/ItemGroup;)V", false));
        ...
        method.instructions.insert(node, new FieldInsnNode(Opcodes.GETFIELD, "com/ultreon/filters/Filters", "events", "Lcom/ultreon/filters/Events;"));
        method.instructions.insert(node, new MethodInsnNode(Opcodes.INVOKESTATIC, "com/ultreon/filters/Filters", "get", "()Lcom/ultreon/filters/Filters;", false))
        return true;
    }
    return false;
}
...
function patch_DisplayEffectsScreen_drawActivePotionEffects(method) {
    ...
    if(node !== null)
    {
        ...
        method.instructions.insert(node, new MethodInsnNode(Opcodes.INVOKESTATIC, "com/ultreon/filters/Hooks", "getPotionEffectOffset", "(Lnet/minecraft/client/gui/DisplayEffectsScreen;)I", false));
        method.instructions.insert(node, new VarInsnNode(Opcodes.ALOAD, 0));
        return true;
    }
    return false;
...
function patch_DisplayEffectsScreen_updateActivePotionEffects(method) {
    ...
    if(node !== null)
    {
        method.instructions.insert(node, new MethodInsnNode(Opcodes.INVOKESTATIC, "com/ultreon/filters/Hooks", "getEffectsGuiOffset", "(Lnet/minecraft/client/gui/DisplayEffectsScreen;)I", false));
        method.instructions.insert(node, new VarInsnNode(Opcodes.ALOAD, 0));
